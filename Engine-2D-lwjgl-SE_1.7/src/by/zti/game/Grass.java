...
public class Grass extends GameObject {
	...
	public Grass(float x, float y, Core core) {
		super(x, y, WIDTH, HEIGTH, new Animation(new Frame("grass", 10000000), 0, "still"), "Grass", false, core, RenderLayers.GROUND_LAYER);
